      ...
      <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
        ...
        <div>
          <div className="lg:w-[570px]">
            <h1 className="text-[36px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading=[70px]" > We  help  you  live  a  healthy  and peaceful life</h1>
            <p className="text__para"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio, voluptatibus hic impedit omnis deleniti eius at similique, a rem voluptatum adipisci quis, facere commodi expedita minus iure saepe beatae facilis?</p>
...
<div>
  ...
  <p className="text_para">Experienced Doctors</p>
  ...
  <p className="text_para">Using this website</p>
  ...
  <p className="text_para"> Satisfaction</p>
      ...
      <div className="flex gap-[30px] justify-end">
        <div>
          <img className="w-full mb-[50px]" src ={image1} alt=""/>
        </div>
  ...
  <section>
    <div class="container">
      <div className="lg:w-[470px] mx-auto">
        <h2 className="heading tetx-center">
           Specialized Help for Your Mental Conditions
        </h2>
        <p className="text_para text-center">
          World-Cares for everyone.Our health System offers unmatched,expert health care.
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px lg:mt-[55px]">
        <div className="py-[30px] px-5">
          ...
          <div className="mt-[30px]">
            ...
            <p className="text-[16px] leading-7 text-textColor font-[400] mt-4  text-center">
              It comes for nowhere,paralyses my thoughts and causes distress
            </p>
        ...
        <div className="py-[30px] px-5">
          ...
          <div className="mt-[30px]">
            ...
            <p className="text-[16px] leading-7 text-textColor font-[400] mt-4  text-center">
              Most people will not understand how you feel....
            </p>
           <Link to='/doctors' className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none">
            <BsArrowRight  className="group-hover:text-white w-6 h-5"/>
           </Link>
...
<div className="xl:w-[670px]">
  ...
  <ul className="pl-4">
    ...
    <li className ="text__para">
      2.Search for your Therapist here, and Take session    </li>
    <li className ="text__para">
...
[8px] leading-[8px] lg:text-[12px] lg: leading-4 text-irisBlueColor font-[500] mt-2 lg
rounded-full">
Consultation
</div>
<div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
<img src={avatarIcon} alt="" />
<h4 className="text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700] text-headingColor"> Wayleen collar</h4>
</div>
</div>
    </div>
    </div>
