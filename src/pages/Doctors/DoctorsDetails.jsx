          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text__para text-[14px] leading-5 md:text=[15px] lg:max-w-[390px]">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Amet obcaecati, vel ipsam sapiente tempore velit adipisci similique reprehenderit. Exercitationem labore incidunt mollitia expedita aspernatur nihil perferendis necessitatibus possimus quod accusantium!
              </p>
            </div>
